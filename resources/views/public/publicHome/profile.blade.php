                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                @if($fin->sex == 'Male')
                                    <a title="Let him know your love" href="{{route('userHome.show', $fin->id)}}"> <img height="100" width="150" src="{{ asset('images/lovebutton.jpg')}}"></a>
                                @else
                                    <a title="Let her know your love" href="{{route('userHome.show', $fin->id)}}"> <img height="100" width="150" src="{{ asset('images/lovebutton.jpg')}}"></a>
                                @endif
                                <br>
